<template>
  <section class="intro">
    <div class="intro__textblock">
      <h2 class="intro__title">Комплексное продвижение на маркетплейсах</h2>
      <p class="intro__text">
...
<style scoped>
.intro {
  background: url(../../../static/img/page2-images/p2_intro-with-icons.jpg)
